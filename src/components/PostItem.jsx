    ...
    <div className="card  bg-base-100 shadow-xl">
      <div className="card-body">
        <div className="flex justify-between">
          ...
          <div className="flex gap-2 items-center relative -top-3">
         { post.userId === user.id && (     // Show edit and delete options only for the post owner
